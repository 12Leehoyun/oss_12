# 제목: 협업 기반 소프트웨어 조사 - 컴퓨터로 온세상을 창조하는 마법 ‘블렌더’

### 팀원
      
      노어노문학과/2019115685/이호윤(12Leehoyun)
...
### 개요
   ...
   블렌더는 무료 오픈 소스 3D 그래픽 소프트웨어이다. 3D 모델링, 애니메이션, 시뮬레이션, 렌더링, 비디오 편집 등의 다양한 기능을 제공한다. 각각의 전문 프로그램들에 비해 기능은 조금씩 부족해 보일지라도 그 모든 분야의 기능들이 한 프로그램에 완전히 통합되 어 있다는 점이 장점이다. 또한 사용자들은 다양한 플랫폼에서 블렌더를 활용할 수 있으며, 커뮤니티 기여와 업데이트를 통해 지속적으로 발전하고 있다.


### 라이선스
   Blender 재단 및 법인/GNU GPLv2 이상/유·무료 공존/부분유료
...
3) 스컬프팅(Sclupting)
   ...
   ![블렌더의 스컬프팅](https://github.com/12Leehoyun/oss_12/assets/166000743/e7c0ee4c-7557-4bbf-a7c5-51c484550101)
